...
#         self._backend = thnn_backend
    ...
    def lrp(self, R, labels, lrp_var=None,param=None):
        ...
        elif lrp_var.lower() =='composite_ori':
            return self._composite_lrp_ori(R, labels, layer_num) # 성환이형한테 받은 original _composite_lrp
        elif lrp_var.lower() =='new_composite':
            return self._composite_new_lrp(R, labels) # 성환이형한테 받고 준하가 수정한 _composite_lrp
        elif lrp_var.lower() =='flrp_acw':
            return self._flrp_acw(R, labels)
        elif lrp_var.lower() =='flrp_aw':
            return self._flrp_aw(R, labels)
    ...
    # ------------------------------------------------------
    """
    lrp_gradients : implemented by inheriting classes.
    """

    def lrp_gradients(self, g_lrp):
